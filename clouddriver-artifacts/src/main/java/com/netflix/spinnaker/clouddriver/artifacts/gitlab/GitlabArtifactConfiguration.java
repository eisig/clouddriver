...
public class GitlabArtifactConfiguration {
  ...
  GitlabArtifactProviderProperties HttpArtifactProviderProperties() {
  ...
  List<? extends GitlabArtifactCredentials> gitlabArtifactCredentials() {
    List<GitlabArtifactCredentials> result = gitlabArtifactProviderProperties.getAccounts()
      .stream()
      .map(a -> {
        try {
          GitlabArtifactCredentials c = new GitlabArtifactCredentials(a, httpOkHttpClient, objectMapper);
    ...
    if (gitlabArtifactProviderProperties.getAccounts().stream().noneMatch(GitlabArtifactAccount::usesAuth)) {
      GitlabArtifactAccount noAuthAccount = new GitlabArtifactAccount()
        .setName("no-auth-gitlab-account");
      GitlabArtifactCredentials noAuthCredentials = new GitlabArtifactCredentials(noAuthAccount, httpOkHttpClient, objectMapper);
